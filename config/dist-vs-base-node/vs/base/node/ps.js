 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(9)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, uri_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(76), __webpack_require__(8)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, child_process_1, amd_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
                ...
                child_process_1.exec(CMD, { maxBuffer: 1000 * 1024 }, function (err, stdout, stderr) {
                    if (err || stderr) {
                        ...
                        if (process.platform === 'linux') {
                            ...
                            var cmd = JSON.stringify(amd_1.getPathFromAmdModule(__webpack_require__(88), 'vs/base/node/cpuUsage.sh'));
                            cmd += ' ' + pids_1.join(' ');
