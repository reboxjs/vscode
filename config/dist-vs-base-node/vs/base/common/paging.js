 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(5), __webpack_require__(28), __webpack_require__(14), __webpack_require__(4), __webpack_require__(11)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, winjs_base_1, types_1, cancellation_1, errors_1, arrays_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function mergePagers(one, other) {
        return {
            ...
            getPage: function (pageIndex, token) {
                return winjs_base_1.TPromise.join([one.getPage(pageIndex, token), other.getPage(pageIndex, token)])
                    .then(function (_a) {
